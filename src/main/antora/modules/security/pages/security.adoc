...
In order to use the identity store, we need to put some data in a database. This is done in the same way as in <<Securing an Endpoint with Basic Authentication and a Database Identity Store>>.
